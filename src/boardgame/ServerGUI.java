...
public class ServerGUI extends JFrame implements BoardPanel.BoardPanelListener {
    ...
    //protected static final String[] PLAYER_CLASSES = { "pentago_twist.RandomPentagoPlayer", "student_player.AdversaryPlayer" };
    protected static final String[] PLAYER_CLASSES = { "student_player.StudentPlayer", "student_player.AdversaryPlayer" };
